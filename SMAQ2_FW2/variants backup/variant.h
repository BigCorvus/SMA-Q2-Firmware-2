...
// LEDs
#define PIN_LED1                (12)			//changed that! used to be 17!!
#define PIN_LED2                (19)
 ...
 */
// Serial
#define PIN_SERIAL_RX       (25) //8
#define PIN_SERIAL_TX       (26) //6
...
#define PIN_WIRE_SDA         (17u) //accelerometer//(19u) heart rate sensor //(25u)
#define PIN_WIRE_SCL         (18u)				//(20u) 				//(26u)

//#define PIN_WIRE1_SDA         (17u) //accelerometer
