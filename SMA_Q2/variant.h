 ...
 */
// Serial
#define PIN_SERIAL_RX       (25) // P0.00
#define PIN_SERIAL_TX       (26) // P0.01
...
#define PIN_SPI_MISO         (11) // P0.22
#define PIN_SPI_MOSI         (3u) // P0.23
#define PIN_SPI_SCK          (2u) // P0.24

static const uint8_t SS   = 5 ;  // P0.25
...
#define PIN_WIRE_SDA         (19u) // P0.20  3
#define PIN_WIRE_SCL         (20u) // P0.21  2
